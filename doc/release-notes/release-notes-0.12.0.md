...
Then, to tunnel a SSL connection on 235883 to a RPC server bound on localhost on port 25883 do:

    stunnel -d 28332 -r 127.0.0.1:25883 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:35883/
        ProxyPassReverse http://127.0.0.1:35883/
